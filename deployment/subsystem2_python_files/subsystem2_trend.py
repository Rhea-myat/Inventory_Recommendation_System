...
SOCIAL_TREND_OUTPUT = OUTPUT_DIR / "social_trend_signals.csv"
ROOT_SOCIAL_TREND_OUTPUT = BASE_DIR / "social_trend_signals.csv"
ROOT_CATEGORY_SOCIAL_OUTPUT = BASE_DIR / "category_social_trends.csv"
...
def load_subsystem1_output() -> pd.DataFrame:
    candidate_files = [
        BASE_DIR.parent / "subsystem1_python_files" / "data" / "output" / "subsystem1_product_recommendations_v2.csv",
